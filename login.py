...
# Conexão e criação da tabela de usuários
...
def fazer_login():
    ...
    if resultado:
        ...
        root.destroy()
        # Aqui você poderia abrir a tela principal da aplicação
    else:
...
tk.Label(frame_cadastro, text="Nome:", bg="#f4f4f4").pack()
...
ttk.Button(frame_cadastro, text="Salvar", command=cadastrar_usuario).pack(pady=15)
ttk.Button(frame_cadastro, text="Voltar", command=voltar_para_login).pack()
